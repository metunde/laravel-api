...
<form action="#" method="post"  @submit.prevent="create">
    <div class="my-10">
                  ...
                  <div class="mt-2">
                    <input v-model="title" id="text" name="text" type="text" autocomplete="off" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
...
<div class="mb-4 w-full bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
    ...
    <div class="py-2 px-4 bg-white rounded-b-lg dark:bg-gray-800">
        <!-- <label for="editor" class="text-white-600">Publish post</label> -->
        <textarea v-model="body" id="editor" rows="8" class="block px-0 w-full text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required></textarea>
    </div>
</div>
